    ...
    <nav class="navbar navbar-default" style="z-index: 4; position: fixed; top: 0; width: 100%">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{url('parent/')}}"> ولي الامر</a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{URL('parent/marks')}}">العلامات</a></li>
                            <li><a href="{{url('parent/messages')}}">الرسائل</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        ...
        <div class="row row-offcanvas row-offcanvas-left">
            ...
            <div class="col-xs-6 col-sm-2 sidebar-offcanvas" id="sidebar" role="navigation">
                <ul class="nav " >
                    ...
                    <li style="text-align: center; margin: 10px 0">اسم ولي الامر</li>
                    <li><span><hr></span></li>
                    <li class="" id="te"><a href="{{url('parent/marks')}}" >العلامات</a></li>

                    <li id="su"><a href="{{url('parent/messages')}}" onclick="">الرسائل</a></li>
                </ul>
