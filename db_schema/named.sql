...
--
-- Host: localhost
-- Generation Time: Apr 28, 2016 at 06:01 PM
...
--
-- Table structure for table `teacherarrival`
--
...
--
ALTER TABLE `grades`
  ADD PRIMARY KEY (`student_id`,`course_id`,`semster`) USING BTREE,
...
--
-- Indexes for table `teacherarrival`
--
...
--
-- Indexes for table `train_courses`
--
...
--
-- Constraints for table `studentadress`
--
ALTER TABLE `studentadress`
  ADD CONSTRAINT `studentadress_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`);

--
-- Constraints for table `teacher`
--
ALTER TABLE `teacheres`
  ADD CONSTRAINT `teacher_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`);

--
-- Constraints for table `teacherarrival`
--
ALTER TABLE `teacherarrivales`
...
--
-- Constraints for table `train_courses`
--
ALTER TABLE `trained_courses`
